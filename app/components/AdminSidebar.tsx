            ...
            <div className="text-center flex flex-col items-center justify-center ">
                <div className="">
                    <nav className="flex flex-col space-y-3">
                        ...
                        <Link href="/admin/dashboard/laporanteknisi" className={pathname === '/admin/dashboard/laporanteknisi' ? 'border bg-primary text-white font-poppins p-3 border-primary rounded-md font-semibold' : 'border border-white text-white font-poppins p-3 rounded-md hover:bg-primary hover:border-primary'}>Laporan Teknisi</Link>
