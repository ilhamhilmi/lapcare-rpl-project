            ...
            <div className="text-center flex flex-col items-center justify-center ">
                <div className="">
                    <nav className="flex flex-col space-y-8">
                        <Link href="/admin/dashboard" className={pathname === '/admin/dashboard' ? 'border bg-primary text-white font-poppins p-3 border-primary rounded-md font-semibold' : 'border border-white text-white font-poppins p-3 rounded-md'}>Dashboard Utama</Link>
                        ...
                        <button className="font-poppins border-red-600 bg-red-600 hover:bg-red-800 hover:border-red-800 rounded-md p-3 cursor-pointer">Logout</button>
                    </nav>
                </div>
            </div>
        </div>
