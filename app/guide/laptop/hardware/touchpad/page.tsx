        ...
        <div>
            ...
            <section className="bg-slate-200 pt-32">
                <div className="container mx-auto">
                    ...
                    <div className="flex justify-center items-center px-4">
                        <p className="text-darkb text-center text-4xl xl:text-5xl font-poppins">Touchpad Tidak Merespon</p>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-slate-200 pt-16 pb-16 px-6">
                <div className="container mx-auto bg-slate-200 border border-secondary rounded-xl shadow-xl p-5">
                    <div>
                        <p className="font-poppins text-darkb text-justify">1. Bersihakn touchpad mu dengan kain kering</p>
                        <p className="font-poppins text-darkb text-justify">2. Pastikan jari tidak basah atau berminyak</p>
                        <p className="font-poppins text-darkb text-justify">3. Gunakan mouse eksternal</p>
                        <p className="font-poppins text-darkb text-justify">4. Jika berfungsi, touchpad mu perlu di service</p>
                    </div>
                </div>
            </section>
