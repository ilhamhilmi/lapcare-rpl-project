        ...
        <div>
            ...
            <section className="bg-slate-200 pt-16 pb-16 px-6">
                <div className="container mx-auto bg-slate-200 border border-secondary rounded-xl shadow-xl p-5">
                    <div>
                        <p className="font-poppins text-darkb text-justify">1. Cabut charger dari laptop</p>
                        <p className="font-poppins text-darkb text-justify">2. Periksa ujung charger, apakah ada bengkok atau kerusakan</p>
                        <p className="font-poppins text-darkb text-justify">3. Coba kabel charger di laptop lain</p>
                        <p className="font-poppins text-darkb text-justify">4. Jika berfungsi di laptop lain, kemungkinan port charger mu mengalami kerusakan</p>
                    </div>
                </div>
            </section>
